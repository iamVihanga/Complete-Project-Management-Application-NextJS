...
import { ArrowLeftIcon, ImageIcon, Loader, Upload } from "lucide-react";
...
export const EditWorkspaceForm = ({
  ...
  const form = useForm<UpdateWorkspaceSchemaT>({
  ...
  const onSubmit = (values: UpdateWorkspaceSchemaT) => {
    const finalValues = {
      ...values,
